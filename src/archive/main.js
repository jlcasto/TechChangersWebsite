$(function() {
    ...
    .resize(function() {
      ...
      if (windowWidth >= 870) {
        $(".announcement-wrapper")
          .remove()
          .insertBefore($(".sidebar-links"))
        addImageHandlers()
      } else {
        $(".sidebar-links")
          .remove()
          .insertBefore($(".announcement-wrapper"))
      }
    })
    .trigger("resize")
  ...
  function addImageHandlers() {
    ...
    imageHandler(
      ".js-donate-home",
      "images/donate-blue-dark.svg",
      "images/donate-blue.svg"
    )
    imageHandler(
      ".js-donate",
      "../images/donate-blue-dark.svg",
    ...
    imageHandler(
      ".js-boarding-home",
      "images/boarding-blue-dark.svg",
      "images/boarding-blue.svg"
    )
    imageHandler(
      ".js-boarding",
      "../images/boarding-blue-dark.svg",
    ...
    imageHandler(
      ".js-calendar-home",
      "images/calendar-blue-dark.svg",
      "images/calendar-blue.svg"
    )
    imageHandler(
      ".js-calendar",
      "../images/calendar-blue-dark.svg",
    ...
    imageHandler(
      ".js-facebook-home",
      "images/facebook-blue-dark.svg",
      "images/facebook-blue.svg"
    )
    imageHandler(
      ".js-facebook",
      "../images/facebook-blue-dark.svg",
    ...
    imageHandler(
      ".js-facebook-footer-home",
      "images/facebook-red.svg",
    ...
    imageHandler(
      ".js-twitter-footer-home",
      "images/twitter-red.svg",
